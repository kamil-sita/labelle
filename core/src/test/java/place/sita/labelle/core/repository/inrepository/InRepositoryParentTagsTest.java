...
public class InRepositoryParentTagsTest extends TestContainersTest {
	...
	public void shouldGetParentTags() {
		...
		inRepositoryService.addTag(parentRepo1Image, null, new Tag("CATEGORY1", "TAG1"));
		inRepositoryService.addTag(parentRepo1Image, null, new Tag("CATEGORY2", "TAG2"));
		...
		inRepositoryService.addTag(parentRepo2Image, null, new Tag("CATEGORY3", "TAG3"));
		inRepositoryService.addTag(parentRepo2Image, null, new Tag("CATEGORY1", "TAG1"));
		...
		inRepositoryService.addTag(parentRepo3Image, null, new Tag("CATEGORY4", "TAG4"));
		...
		inRepositoryService.addTag(unrelatedRepoImage, null, new Tag("CATEGORY5", "TAG5"));
		...
		inRepositoryService.addTag(parentRepo2UnrelatedImage, null, new Tag("CATEGORY6", "TAG6"));
		...
		inRepositoryService.addTag(childRepoImage, null, new Tag("CATEGORY7", "TAG7"));
