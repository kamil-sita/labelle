...
import place.sita.labelle.jooq.tables.records.TagCategoryRecord;
...
public class Keys {
    ...
    public static final UniqueKey<TagCategoryRecord> TAG_SRC_PKEY = Internal.createUniqueKey(TagCategory.TAG_CATEGORY, DSL.name("tag_src_pkey"), new TableField[] { TagCategory.TAG_CATEGORY.ID }, true);
    public static final UniqueKey<TagTranslationRecord> TAG_TRANSLATION_PKEY = Internal.createUniqueKey(TagTranslation.TAG_TRANSLATION, DSL.name("tag_translation_pkey"), new TableField[] { TagTranslation.TAG_TRANSLATION.REPOSITORY_ID }, true);
    ...
    public static final ForeignKey<ImageDeltaRecord, ImageRecord> IMAGE_DELTA__FK_IMAGE_DELTA_IMAGE_ID = Internal.createForeignKey(ImageDelta.IMAGE_DELTA, DSL.name("fk_image_delta_image_id"), new TableField[] { ImageDelta.IMAGE_DELTA.IMAGE_ID }, Keys.IMAGE_PKEY, new TableField[] { Image.IMAGE.ID }, true);
    public static final ForeignKey<ImageDeltaRecord, ImageResolvableRecord> IMAGE_DELTA__FK_IMAGE_DELTA_IMAGE_RESOLVABLE_ID = Internal.createForeignKey(ImageDelta.IMAGE_DELTA, DSL.name("fk_image_delta_image_resolvable_id"), new TableField[] { ImageDelta.IMAGE_DELTA.IMAGE_RESOLVABLE_ID }, Keys.IMAGE_RESOLVABLE_PKEY, new TableField[] { ImageResolvable.IMAGE_RESOLVABLE.ID }, true);
    ...
    public static final ForeignKey<TagRecord, TagCategoryRecord> TAG__FK_TAG_TAG_SRC_ID_3b = Internal.createForeignKey(Tag.TAG, DSL.name("fk_tag_tag_src_id;"), new TableField[] { Tag.TAG.TAG_CATEGORY_ID }, Keys.TAG_SRC_PKEY, new TableField[] { TagCategory.TAG_CATEGORY.ID }, true);
    public static final ForeignKey<TagCategoryRecord, RepositoryRecord> TAG_CATEGORY__FK_TAG_SRC_REPOSITORY_ID = Internal.createForeignKey(TagCategory.TAG_CATEGORY, DSL.name("fk_tag_src_repository_id"), new TableField[] { TagCategory.TAG_CATEGORY.REPOSITORY_ID }, Keys.CATALOGUE_PKEY, new TableField[] { Repository.REPOSITORY.ID }, true);
    public static final ForeignKey<TagDeltaRecord, ImageRecord> TAG_DELTA__FK_IMAGE_DELTA_IMAGE_ID = Internal.createForeignKey(TagDelta.TAG_DELTA, DSL.name("fk_image_delta_image_id"), new TableField[] { TagDelta.TAG_DELTA.IMAGE_ID }, Keys.IMAGE_PKEY, new TableField[] { Image.IMAGE.ID }, true);
    ...
    public static final ForeignKey<TagTranslationRecord, RepositoryRecord> TAG_TRANSLATION__FK_TAG_TRANSLATION_REPOSITORY_ID = Internal.createForeignKey(TagTranslation.TAG_TRANSLATION, DSL.name("fk_tag_translation_repository_id"), new TableField[] { TagTranslation.TAG_TRANSLATION.REPOSITORY_ID }, Keys.CATALOGUE_PKEY, new TableField[] { Repository.REPOSITORY.ID }, true);
