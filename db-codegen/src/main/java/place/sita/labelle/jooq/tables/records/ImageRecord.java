...
public class ImageRecord extends UpdatableRecordImpl<ImageRecord> implements Record8<UUID, UUID, UUID, String, String, Boolean, Boolean, Boolean> {
    ...
    /**
     * Setter for <code>public.image.visible_to_children</code>.
     */
    public void setVisibleToChildren(Boolean value) {
        set(7, value);
    }

    /**
     * Getter for <code>public.image.visible_to_children</code>.
     */
    public Boolean getVisibleToChildren() {
    ...
    @Override
    public Row8<UUID, UUID, UUID, String, String, Boolean, Boolean, Boolean> valuesRow() {
    ...
    public Field<Boolean> field8() {
        return Image.IMAGE.VISIBLE_TO_CHILDREN;
    }
    ...
    @Override
    public ImageRecord value8(Boolean value) {
        setVisibleToChildren(value);
        return this;
    }

    @Override
    public ImageRecord values(UUID value1, UUID value2, UUID value3, String value4, String value5, Boolean value6, Boolean value7, Boolean value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ImageRecord(UUID imageResolvableId, UUID repositoryId, UUID id, String referenceId, String parentReference, Boolean useTagDelta, Boolean useImageDelta, Boolean visibleToChildren) {
        super(Image.IMAGE);
        ...
        setVisibleToChildren(visibleToChildren);
    }
}
