...
public class RepositoryRecord extends UpdatableRecordImpl<RepositoryRecord> implements Record2<UUID, String> {
    ...
    /**
     * Setter for <code>public.repository.name</code>.
     */
    ...
    /**
     * Getter for <code>public.repository.name</code>.
     */
    ...
    @Override
    public RepositoryRecord value1(UUID value) {
        setId(value);
        return this;
    }
    ...
    @Override
    public RepositoryRecord values(UUID value1, String value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    public RepositoryRecord(UUID id, String name) {
        super(Repository.REPOSITORY);
